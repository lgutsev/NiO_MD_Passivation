...
optimization/450 K MD/final-quench array. The default campaign gives replica 0
of each size family a 6 ps head-facing stage that weakly steers P--P separation
and both bonded C--P···P axes, followed by 14 ps of unbiased MD; every other
replica receives 20 ps of unbiased MD. Validated
...
verify cell containment, requested vacuum, periodic-image clearance, contact
